...
class hsr_cnn_detection(object):
    ...
    def __init__(self):
        ...
        self.point_publisher = rospy.Publisher('segmented_point', PointCloud2, queue_size=10)
    ...
    def project_2d_3d(self, image_msg, depth_msg):
        ...
        # self.point_publisher.publish(self.o3d_to_pointcloud2(self.pcd.points, 'segmented_point'))
